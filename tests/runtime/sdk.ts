...
export const db = {
  list: async (..._args: unknown[]) => ({ items: [], nextToken: undefined }),
...
export const secrets = {
  readSecret: async (_name: string): Promise<string> => {
    throw new Error('Secret is not configured in tests');
  },
  listSecretNames: async () => [],
};
export const json = (data: unknown, statusCode = 200) => ({
  statusCode,
